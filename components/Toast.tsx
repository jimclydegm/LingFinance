...
export const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={cn(
        "fixed bottom-6 right-6 z-50 max-w-lg w-full p-4 rounded-xl border shadow-2xl backdrop-blur-md transition-all duration-300 animate-in slide-in-from-bottom-5",
