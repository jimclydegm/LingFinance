  ...
  const navItems = [
    {
      ...
      description: "Hyperscale vs ACIE shift reasoning & Recharts bar chart",
      icon: BarChart3,
      badge: "Demo 1",
    ...
    },
    {
      ...
      description: "Google 2026 Q2 actuals mapping & 5,000+ formula updates",
      icon: Table,
      badge: "Demo 2",
    ...
    },
    {
      ...
      description: "Spire historical profit validation & $17.8M calculation",
      icon: Search,
      badge: "Demo 3",
